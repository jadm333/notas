...
- [Scala functional programming](#scala-functional-programming)
...
- [Design Patterns](#design-patterns)
    - [Reactive SheetCheat](#reactive-sheetcheat)
    - [Partial Functions](#partial-functions)
    - [For-Comprehension and Pattern Matching](#for-comprehension-and-pattern-matching)
    - [Random Generators with For-Expressions](#random-generators-with-for-expressions)
    - [Monads](#monads)
    - [Monads and For-Expression](#monads-and-for-expression)
    - [Pure functional programming](#pure-functional-programming)
    - [Mutable state](#mutable-state)
    - [Loops](#loops)
    - [For loop](#for-loop)
    - [Monads and Effect](#monads-and-effect)
            - [Try](#try)
    - [Monads and Latency](#monads-and-latency)
            - [Future](#future)
            - [Combinators on Future](#combinators-on-future)
            - [async and await](#async-and-await)
            - [Promises](#promises)
    - [Observables](#observables)
            - [Subscriptions](#subscriptions)
            - [Creating Rx Streams](#creating-rx-streams)
            - [Blocking Observables](#blocking-observables)
            - [Schedulers](#schedulers)
    - [Actors](#actors)
            - [The Actor's Context](#the-actors-context)
            - [Children and hierarchy](#children-and-hierarchy)
            - [Message Processing Semantics](#message-processing-semantics)
            - [Designing Actor Systems](#designing-actor-systems)
            - [Testing Actor Systems](#testing-actor-systems)
            - [Logging Actor Systems](#logging-actor-systems)
            - [Failure handling with Actors](#failure-handling-with-actors)
            - [Lifecycle of an Actor](#lifecycle-of-an-actor)
            - [Lifecycle Monitoring](#lifecycle-monitoring)
            - [The Error Kernel pattern](#the-error-kernel-pattern)
            - [EventStream](#eventstream)
            - [Persistent Actor State](#persistent-actor-state)
    - [Clusters](#clusters)
